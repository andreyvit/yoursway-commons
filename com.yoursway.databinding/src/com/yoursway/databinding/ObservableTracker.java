...
public class ObservableTracker {
	...
	private static ThreadLocal<Set> currentObservableSet = new ThreadLocal<Set>();
	...
	public static IObservable[] runAndMonitor(Runnable runnable,
		...
		Set lastObservableSet = currentObservableSet.get();
	...
	public static void getterCalled(IObservable observable) {
		...
		Set<IdentityWrapper> lastObservableSet = currentObservableSet.get();
