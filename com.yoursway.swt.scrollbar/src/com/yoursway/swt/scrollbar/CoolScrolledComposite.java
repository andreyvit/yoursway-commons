...
public class CoolScrolledComposite extends Composite {
	...
	public CoolScrolledComposite(Composite parent, int style) {
		...
		verticalBar = new CoolScrollBar(this, SWT.NONE, true);
		verticalBar.setLayoutData(GridDataFactory.fillDefaults().grab(false, true).create());

		horizontalBar = new CoolScrollBar(this, SWT.NONE, false);
	...
	/**
	 * Returns <code>true</code> if the content control will be expanded to
	 ...
	 *                <li>ERROR_THREAD_INVALID_ACCESS - if not called from the
	 *                thread that created the receiver</li>
	 *                <li>ERROR_INVALID_ARGUMENT - value of origin is outside
	 *                of content
	 *                </ul>
	 * @since 2.0
	 */
...
//			}
	 ...
	 * to make it visible.
	 * 
	 * If show is <code>false</code>, show a focused control is off. By
	 * default, show a focused control is off.
	 * 
	 * @param show
