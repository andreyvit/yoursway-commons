 ...
 * </p>
 * @see RelativePathImpl
 */
public interface RelativePath extends Cloneable {
	 ...
	 * where the path is considered to be UNC.
	 *
	 * @param relativePath the path to concatenate
	 * @return the new path
	 */
	...
	* if each of the segments in its canonicalized form is valid.
	 ...
	 * @see #getDevice()
	 */
	public RelativePath setDevice(String device);
	 ...
	 * @see RelativePathImpl#fromPortableString(String)
	 * @since 3.1
	 */
